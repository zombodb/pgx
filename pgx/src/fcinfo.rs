...
use crate::{pg_sys, FromDatum, PgMemoryContexts};
...
mod pg_12_13 {
    ...
    pub fn pg_getarg<T: FromDatum>(
        fcinfo: PgPtr<pg_sys::FunctionCallInfoBaseData>,
        num: usize,
    ) -> Option<T> {
    ...
    #[inline]
    pub fn pg_arg_is_null(fcinfo: PgPtr<pg_sys::FunctionCallInfoBaseData>, num: usize) -> bool {
    ...
    #[inline]
    pub fn pg_return_null(fcinfo: PgPtr<pg_sys::FunctionCallInfoBaseData>) -> pg_sys::Datum {
        let fcinfo = unsafe { fcinfo.as_mut() }.unwrap();
        fcinfo.isnull = true;
        0 as pg_sys::Datum
    }
...
#[inline]
pub fn get_getarg_type(fcinfo: PgPtr<pg_sys::FunctionCallInfoBaseData>, num: usize) -> pg_sys::Oid {
    unsafe {
...
pub fn pg_func_extra<ReturnType, DefaultValue: FnOnce() -> ReturnType>(
    ...
    if fcinfo.flinfo.fn_extra.is_null() {
        fcinfo.flinfo.fn_extra =
            PgMemoryContexts::For(flinfo.fn_mcxt).leak_and_drop_on_delete(default());
    }
...
pub unsafe fn direct_function_call<R: FromDatum>(
    func: unsafe fn(PgPtr<pg_sys::FunctionCallInfoBaseData>) -> pg_sys::Datum,
...
fn make_function_call_info(
    ...
    arg_array: [usize; 100],
    null_array: [bool; 100],
) -> PgPtr<pg_sys::FunctionCallInfoData> {
    let mut fcinfo = PgPtr::<pg_sys::FunctionCallInfoData>::new();
...
fn make_function_call_info(
    ...
    arg_array: [usize; 100],
    null_array: [bool; 100],
) -> PgPtr<pg_sys::FunctionCallInfoBaseData> {
    let fcinfo = PgPtr::<pg_sys::FunctionCallInfoBaseData>::with_extra_len0(
...
#[inline]
pub fn srf_is_first_call(fcinfo: PgPtr<pg_sys::FunctionCallInfoBaseData>) -> bool {
    fcinfo.flinfo.fn_extra.is_null()
}

#[inline]
pub fn srf_first_call_init(
    fcinfo: PgPtr<pg_sys::FunctionCallInfoBaseData>,
) -> PgPtr<pg_sys::FuncCallContext> {
    unsafe { pg_sys::init_MultiFuncCall(fcinfo) }
}

#[inline]
pub fn srf_per_call_setup(
    fcinfo: PgPtr<pg_sys::FunctionCallInfoBaseData>,
) -> PgPtr<pg_sys::FuncCallContext> {
    unsafe { pg_sys::per_MultiFuncCall(fcinfo) }
}

#[inline]
pub fn srf_return_next(
    fcinfo: PgPtr<pg_sys::FunctionCallInfoBaseData>,
    funcctx: PgPtr<pg_sys::FuncCallContext>,
) {
    funcctx.call_cntr += 1;

    fcinfo.resultinfo.cast::<pg_sys::ReturnSetInfo>().isDone =
...
pub fn srf_return_done(
    ...
    fcinfo.resultinfo.cast::<pg_sys::ReturnSetInfo>().isDone = pg_sys::ExprDoneCond::ExprEndResult;
}
